--
-- Archivo generado con SQLiteStudio v3.4.4 el jue. mar. 14 16:13:22 2024
--
...
-- Tabla: fact_cabe
CREATE TABLE IF NOT EXISTS fact_cabe (id_cab_fact INTEGER PRIMARY KEY NOT NULL, id_dle INTEGER NOT NULL, id_tipo_pago TEXT NOT NULL, id_mesero INTEGER NOT NULL, id_cajero INTEGER NOT NULL, descuento REAL NOT NULL, iva REAL NOT NULL, total REAL NOT NULL, hora_fact NUMERIC NOT NULL, fecha_fact NUMERIC NOT NULL, fact_detalle_id_det_fact INTEGER NOT NULL);

-- Tabla: fact_detalle
CREATE TABLE IF NOT EXISTS fact_detalle (id_det_factura INTEGER PRIMARY KEY NOT NULL, num_factura TEXT NOT NULL, producto TEXT NOT NULL, cant_producto INTEGER NOT NULL, prec_unitario REAL NOT NULL, total REAL NOT NULL);
...
-- Tabla: reg_empleados
CREATE TABLE IF NOT EXISTS reg_empleados (id_empleados INTEGER PRIMARY KEY AUTOINCREMENT, nom_empleados TEXT NOT NULL, ape_empleados TEXT NOT NULL, ced_empleados TEXT UNIQUE NOT NULL, tel_empleados TEXT UNIQUE NOT NULL, usuario TEXT UNIQUE NOT NULL, clave TEXT UNIQUE NOT NULL, rol INTEGER NOT NULL);
